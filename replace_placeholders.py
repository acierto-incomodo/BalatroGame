...
REPLACEMENTS = {
    "{NAME}": "Balatro",       # Nombre visible del juego
    "{ID}": "balatro",         # ID usado en rutas/carpetas (sin espacios)
    "{REMOVE}": "Balatro",  # Nombre del ejecutable/proceso a cerrar
    "{GITHUB}": "https://github.com/acierto-incomodo/BalatroGame",
    "{OLDREMOVE}": "",
    "{OLDDIR}": "",
}
