...
BUILD_URL_WIN = "https://github.com/acierto-incomodo/BalatroGame/releases/latest/download/Build.zip"
BUILD_URL_LINUX = "https://github.com/acierto-incomodo/BalatroGame/releases/latest/download/BuildLinux.zip"
VERSION_URL = "https://github.com/acierto-incomodo/BalatroGame/releases/latest/download/Version.txt"
RELEASE_NOTES_URL = "https://github.com/acierto-incomodo/BalatroGame/releases/latest/download/ReleaseNotes.txt"

EXE_NAME_WIN   = "Build/Balatro.exe"
EXE_NAME_LINUX = "Balatro Linux.x86_64"
...
class LauncherWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Balatro Launcher")
    ...
    def setup_ui(self):
        ...
        title = QtWidgets.QLabel("Balatro")
