[Setup]
AppName=Balatro by StormGamesStudios
AppVersion=1.0.5
DefaultDirName={userappdata}\StormGamesStudios\NewGameDir\BalatroGame
DefaultGroupName=StormGamesStudios
OutputDir=C:\Users\melio\Documents\GitHub\BalatroGame\output
OutputBaseFilename=Balatro_Launcher_Installer
Compression=lzma
...
[Files]
Source: "C:\Users\melio\Documents\GitHub\BalatroGame\dist\installer_updater.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\BalatroGame\BalatroGame.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\BalatroGame\BalatroGame.png"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{commonprograms}\StormGamesStudios\Balatro"; Filename: "{app}\installer_updater.exe"; IconFilename: "{app}\BalatroGame.ico"; Comment: "Lanzador de Balatro"; WorkingDir: "{app}"
Name: "{commonprograms}\StormGamesStudios\Desinstalar Balatro"; Filename: "{uninstallexe}"; IconFilename: "{app}\BalatroGame.ico"; Comment: "Desinstalar Balatro"

[Registry]
Root: HKCU; Subkey: "Software\Balatro"; ValueType: string; ValueName: "Install_Dir"; ValueData: "{app}"

[UninstallDelete]
Type: filesandordirs; Name: "{app}"

[Run]
Filename: "{app}\installer_updater.exe"; Description: "Ejecutar Balatro"; Flags: nowait postinstall skipifsilent
...
begin
  ...
  RunUninstaller(ExpandConstant('{userappdata}\StormGamesStudios\NewGameDir\BalatroGame'));
...
begin
  ...
  Exec('taskkill', '/F /IM "Balatro.exe"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
